 ...
 *       &lt;sequence&gt;
 *         &lt;element name="holiday" type="{http://www.w3.org/2001/XMLSchema}date" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Holidays {
    ...
    protected List<XMLGregorianCalendar> holiday;
     ...
     * 
     */
    public List<XMLGregorianCalendar> getHoliday() {
        if (holiday == null) {
            holiday = new ArrayList<XMLGregorianCalendar>();
        }
        return this.holiday;
    }
